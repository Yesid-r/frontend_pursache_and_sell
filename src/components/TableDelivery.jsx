                    ...
                    {dataCustomer ? (
                        dataCustomer.map((customer, index) => (
                            <tr key={index} className={index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                                ...
                                <td> <button class="bg-blue-500 hover:bg-blue-700 text-white justify-center rounded" onClick={()=>{handleOpenModal(customer.customer._id)}}>
                                    <svg
                                ...
                                <td className='px-6 py-4 whitespace-nowra'>0</td>
                                <td className='px-6 py-4 whitespace-nowra'>0</td>
                            </tr>
                        ))
                    ) : (
